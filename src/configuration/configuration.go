...
func GetConfiguration() *Configuration {
	if _configuration == nil {
		...
		_configuration = &Configuration{
			...
			GophermapTemplateName:  getEnv("GOPHERMAP_TEMPLATE_NAME", ".gophermap"),
			TemplateFileExtension:  getEnv("TEMPLATE_FILE_EXTENSION", ".tmpl"),
			LuaScriptFileExtension: getEnv("LUA_FILE_EXTENSION", ".lua"),
